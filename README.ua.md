...
- У папці `goit-js-hw-03` створи структуру проєкта, як показано в завданні.

⚠️ **Зверни увагу!**  
Імена файлів і папок, а також структура вкладеності, мають **точно відповідати** вказаній схемі. В іншому разі робота не буде прийнята.
...
Перед початком розв’язання ознайомимось із новим терміном.
...
можна створити **slug** із назви статті. У результаті адреса буде більш зручною для сприйняття:  
`mysite.com/posts/arrays-for-beginners`.

**Slug** — це завжди рядок у нижньому регістрі, слова в якому розділені тире.

З цим розібралися? А тепер давай нарешті виконувати завдання!
...
- значення параметра `title` — це рядок, у якому слова розділені **лише пробілами**;
...
- Використовуй умовний оператор `if` усередині циклу для перевірки кожного елемента і додавання його до свого масиву.
...
**Жива сторінка: [GitHub Pages](https://akinaru72.github.io/goit-js-hw-03/)**
